...
function get_detalles_proyecto_card(codigo,nombre,direccion,municipio,latitud,longitud,desde,area,foto_logo,foto_portada,foto_uno,foto_dos,foto_tres,foto_video,tipopago,detalles){

    get_tab('tres');

    let card = card_proyecto(codigo,nombre,direccion,municipio,latitud,longitud,desde,area,foto_logo,foto_portada,foto_uno,foto_dos,foto_tres,foto_video,tipopago,detalles)
...
function card_proyecto(codigo,nombre,direccion,municipio,latitud,longitud,desde,area,foto_logo,foto_portada,foto_uno,foto_dos,foto_tres,foto_video,tipopago,detalles){
    ...
    let tipodispositivo = F.detectarPc();
        ...
        <div class="product-slide-wrapper">
            <div class="product-slides owl-carousel">
                ...
                <div class="single-product-slide" style="background-image: url('${foto_tres}')"></div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <a class="animate__animated animate__zoomInLeft btn btn-danger hand col-12" href="https://api.whatsapp.com/send/?phone=50239160727&text=Hola+Burgos+State+%21%21+quisiera+informaci%C3%B3n+sobre+${nombre}%21%21&type=phone_number&app_absent=0" target="_blank">
                                <i class="lni lni-whatsapp"></i> Mándame información!!
                            </a>
                        </div>
                        <div class="col-6">
                ...
                <div class="p-specification bg-white mb-3 py-3">
                    <div class="container">
                        ...
                        <ul class="mb-3 ps-3">
                            ...
                            <li><b class="negrita text-danger"><i class="lni lni-checkmark-circle"> </i> ${tipopago}</b></li>
                        </ul>
                    </div>
                </div>
